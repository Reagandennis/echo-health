    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-6 text-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-brand/55 leading-relaxed">
            ...
            <span className="font-semibold text-brand">Forgot password?</span> there
      ...
      <div className="flex flex-col gap-5">
        <button
          ...
          className="w-full rounded-xl bg-brand py-3 text-sm font-semibold text-white hover:opacity-90 transition-opacity shadow-sm"
        >
          Go to sign-in page
        </button>
