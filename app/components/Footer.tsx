  ...
  return (
    <footer className="border-t border-stone-200/70 bg-white">
      <div className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-2 gap-10 sm:grid-cols-4">
        <div className="col-span-2 sm:col-span-1 flex flex-col gap-4">
          ...
          <div className="flex gap-4 mt-1">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-stone-400 hover:text-stone-700 transition-colors">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-stone-400 hover:text-stone-700 transition-colors">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-stone-400 hover:text-stone-700 transition-colors">
        ...
        {COLUMNS.map((col) => (
          <div key={col.title} className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 text-sm text-stone-500">
              {col.links.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-brand-700 transition-colors">{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
      ...
      <div className="border-t border-stone-200/70">
        <div className="mx-auto max-w-6xl px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-500">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/cookies" className="hover:text-brand-700 transition-colors">Cookie Settings</Link>
          </div>
        </div>
      </div>
    </footer>
